...
const features = [
  ...
  },
  {
    ...
    subtitle: 'Order today, get today'
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const TrustFeatures = () => {
  return (
    <section className="py-8 bg-gradient-to-r from-magenta-600 via-magenta-700 to-magenta-600">
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-magenta-200 text-xs md:text-sm">{feature.subtitle}</p>
              </div>
            </motion.div>
          ))}
        </div>
